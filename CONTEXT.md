...
76 modules, 680 axiom-clean named results (theorem/lemma) + 209 defs (counts via `scripts/stats.sh`).
...
to the current 680-result corpus (the frontier and architectural-review deepening sweeps) are

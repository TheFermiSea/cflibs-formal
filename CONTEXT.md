...
75 modules, 677 axiom-clean named results (theorem/lemma) + 208 defs (counts via `scripts/stats.sh`).
...
to the current 677-result corpus (the frontier and architectural-review deepening sweeps) are

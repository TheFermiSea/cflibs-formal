...
65 modules, 547 axiom-clean named results (theorem/lemma) + 181 defs (counts via `scripts/stats.sh`).
...
to the current 547-result corpus (the frontier and architectural-review deepening sweeps) are

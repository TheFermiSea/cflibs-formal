...
| `Alt/LeastSquares.lean` | `CflibsFormal.Alt` | 6 | 6 | – | ✓ | the multi-line ordinary-least-squares Boltzmann-plot estimator |
| `Alt/OLSVariance.lean` | `CflibsFormal.Alt` | 8 | 2 | – | ✓ | the Gauss–Markov variance law for the OLS Boltzmann-plot slope |
...
| `ErrorBudget.lean` | `CflibsFormal` | 18 | 0 | – | – | the error-propagation chain and DERIVED reliability thresholds |
